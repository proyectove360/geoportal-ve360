...
define({
  root: {
    ...
    faqs: {
      ...
      howtouseanswer: "Currently the options that can be used are: The Catalog is a general listing of metadata. Through it, you can find all layers made available to you by VE360 and allied organizations a query detailed information about each of them. Likewise, through its buttons, you can preview the layers or add them to the map tab. In the Map you can visualize those layers that have been added from the catalog. Map contains a button where you can find a list of those layers added and the legend. Through the layer list, you can look into the attributes table that will open in the lower side.",
